...
public class MainActivity extends AppCompatActivity {
    ...
    public void Delete(View view){
        ...
        final DatabaseReference delRef = FirebaseDatabase.getInstance().getReference().child("Student").child("Std1");
